...
namespace QuickSoft.Areas.Property.Controllers
{
    ...
    public class PropertyReportsController : BaseController
    {
        ...
        public ActionResult PropertySummery(propertysummery vmodel)
        {
            ...
            DateTime fromdate = string.IsNullOrWhiteSpace(vmodel.startdate) ? new DateTime(1900, 1, 1) : DateTime.Parse(vmodel.startdate, new CultureInfo("En-GB"));
            DateTime enddate = string.IsNullOrWhiteSpace(vmodel.enddate) ? new DateTime(2999, 12, 31) : DateTime.Parse(vmodel.enddate, new CultureInfo("En-GB"));
