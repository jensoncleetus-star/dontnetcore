...
!function(a, b) {
    ...
    a.MixItUp.prototype = {
        ...
        _filter: function() {
            ...
            var data = localStorage.getItem(b._activeFilter);
          
            if (".portfolio" == b._activeFilter) {
            ...
            return;
                ...
                var data = localStorage.getItem(b._activeFilter);
                b._$targets = b._origOrder;
                if (data == null || data == "") {
                    var leng = b._$show.length;
                   

                    b._$show[c] = b._$show.splice(0, leng);
                    ...
                    b._execAction("_filter", 1)
                    for (var c = 0; c < b._$show.length; c++) {
                        str = str + b._$show[c].outerHTML;
                    }
                    str = str.replaceAll("undefined", '');
                    localStorage.setItem(b._activeFilter, str);
                    data = localStorage.getItem(b._activeFilter);
                    str = "";
                    //b._execAction("_filter", 1)
                }
                else {
                    $("#portfoliolist.portfolio").css("display", "block");
                    $("#portfoliolist").html('');
