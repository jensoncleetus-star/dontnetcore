...
function calendarJs( id, options, startDateTime ) {
    ...
    function buildEventEditingDialog() {
        ...
        _element_EventEditorDialog_Title = createElement( "textarea", null, "text" );
      ...
      //  _element_EventEditorDialog_DateFrom.onchange = isAllDayChanged;
       ...
       // _element_EventEditorDialog_DateTo.onchange = isAllDayChanged;
        ...
        //}
        createTextHeaderElement(contents, "Customer Details");
        _element_EventEditorDialog_Location = createElement("a", "custom-scroll-bars");
        contents.appendChild(_element_EventEditorDialog_Location);
        createTextHeaderElement( contents, _options.descriptionText);

        _element_EventEditorDialog_Description = createElement( "a", "custom-scroll-bars" );
   ...
   // }
    ...
    function showEventDialog( eventDetails, overrideTodayDate ) {
        ...
        if ( isDefined( eventDetails ) ) {
            ...
            _element_EventEditorDialog_Description.innerHTML = "Click Here For Deails";
            _element_EventEditorDialog_Description.href = getString(eventDetails.description);
            _element_EventEditorDialog_Description.target = "_new";
            _element_EventEditorDialog_Location.innerHTML= getString( eventDetails.location );
