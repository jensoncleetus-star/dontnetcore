    ...
    public class ItemController : BaseController
    {
        ...
        public JsonResult Create(ItemViewModel ProdViewModel, string fnval, int? printcount)
        {
            ...
            else
            {
                ...
                ProdViewModel.ConRate = Convert.ToDecimal(getrate);
            }
        ...
        public JsonResult Edit(Int64 id, ItemViewModel ProdViewModel, string fnval, int? printcount)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    items.ConFactor = ProdViewModel.ConFactor;
                    ...
                    items.OpeningCost = (ProdViewModel.StockValue != 0 && ProdViewModel.StockValue != null) ? (decimal)(ProdViewModel.StockValue / ProdViewModel.OpeningStock) : 0;
        ...
        public JsonResult GetAddItemSearch2(long? brand, long? category, long? mc, string itemWord)
        {
            ...
            var v1 = (from a in db.Items
                      ...
                      }).ToList().Select(o => new StockDetails2
                      {
                          ...
                          CurrentStock = 0,
                          days = o.days,
                          margin=(o.difference==0)?0:(o.difference/o.PurchasePrice)*100
