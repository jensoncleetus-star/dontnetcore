...
namespace QuickSoft.Controllers
{
    public class LocationController : BaseController
    {
        ...
        public ActionResult GetLocation(string SizeName)
        {
            ...
            var v = (from a in db.LocationNames
                     join b in db.States on a.StateId equals b.StateID into cont1
            ...
            {
                // Apply search   
                v = v.Where(p => p.Location.ToString().ToLower().Contains(search.ToLower()));
            }
        ...
        public JsonResult Create([Bind("LocationId,Location,StateID")] LocationName Locations)
        {
            bool stat = false;
            string msg;
            Int64 Id = 0;
            ...
            if (ModelState.IsValid)
            {
                ...
                db.LocationNames.Add(Locations);
                db.SaveChanges();
                Id = Locations.LocationId;

                var UserId = User.Identity.GetUserId();
                com.addlog(LogTypes.Created, UserId, "LocationName", "LocationNames", findip(), Locations.LocationId, "Location Added Successfully");
