...
{
    public class ApproveMcController : Controller
    {
        ApplicationDbContext db;
        Common com;
        // GET: AdditionalMC
        public ApproveMcController()
        {
            ...
            if (ModelState.IsValid)
            {
                if (ViewModel.Employees != null)
                {
                    foreach (var arr in ViewModel.Employees)
                    {
                        ...
                        var Mc = db.purchaseapproval.Where(a => a.UserId == UserId && a.McName == McName).FirstOrDefault();
                        ...
                        else
                        {
                            ...
                            purchaseapproval mc = new purchaseapproval
                            {
                                UserId      =   UserId,
                                McId        =   ViewModel.McId,
                                McName      =   McName
        ...
        public JsonResult GetAddMc()
        {
            ...
            var UserView = (from a in db.purchaseapproval
                            ...
                            select new
                            {
                                ...
                                Employees = (from z in db.purchaseapproval
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var purchaseapproval = db.purchaseapproval.Where(a => a.McId == id).FirstOrDefault();
            ...
            //****** MC
            ViewModel.McId      =   purchaseapproval.McId;
            ViewModel.McName    =   purchaseapproval.McName;

            var Mcs = db.MCs.Select(s => new { ID = s.MCId, Name = s.MCName }).ToList();
            ViewBag.Mc = QkSelect.List(Mcs, "ID", "Name");

            //****** Employees            
            var Employees = (from a in db.purchaseapproval
        ...
        public JsonResult Edit(long? id, AdditionalMCViewModel ViewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var Employees = db.purchaseapproval.Where(a => a.McId == McId);
                if (Employees != null)
                {
                    db.purchaseapproval.RemoveRange(db.purchaseapproval.Where(a => a.McId == McId));
                    db.SaveChanges();
                }
        ...
        public ActionResult Delete(long? id)
        {
            ...
            var Obj = db.purchaseapproval.Where(a => a.McId == id).FirstOrDefault();
        ...
        public ActionResult DeleteAction(long id)
        {
            ...
            //***********Delete from table purchaseapproval

            var Obj = db.purchaseapproval.Where(a => a.McId == McId).FirstOrDefault();
