...
namespace QuickSoft.Controllers
{
    ...
    public class LeadsController : BaseController
    {
        ...
        public string closelead(long? id)
        {
                    ...
                    if (pflow != null)
                    {
                        if (pflow.movetofieldservice == true && pflow.approvalreq == false)
                        {
                            ...
                            if (v == null)
                            {
                                ...
                                if (db.LocationNames.Find((long)customer.LocationID) != null)
                                {
                                    var locationName = db.LocationNames.Find((long)customer.LocationID);
                                }
