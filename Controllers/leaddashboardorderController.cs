...
{
    public class leaddashboardorderController: BaseController
    {
        ApplicationDbContext db;
        Common com;
        public leaddashboardorderController()
        {
        ...
        public ActionResult getleaddashboard(string SizeName)
        {
            ...
            var v = (from a in db.leaddashbordorder
                     join b  in db.LeadStatuss on a.lead equals b.LeadStatusID 
        ...
        public ActionResult Create()
        {
                ...
                var status = db.LeadStatuss
                             .Select(s => new
                             {
                                 FieldID = s.LeadStatusID,
                                 FieldName = s.StatusType
        ...
        public JsonResult Create(leaddashbordorder dash)
        {
            bool stat = false;
            string msg;
            Int64 Id = 0;
            ...
            if (ModelState.IsValid)
            {
                ...
                db.leaddashbordorder.Add(dash);
                db.SaveChanges();
                Id = dash.leaddashboardid;

                var UserId = User.Identity.GetUserId();
                com.addlog(LogTypes.Created, UserId, "Lead Dashboard", "lead dashboard order", findip(), dash.leaddashboardid, "lead dashboard positon Added Successfully");
        ...
        public ActionResult Edit(long? id)
        {
            ...
            leaddashbordorder dash = db.leaddashbordorder.Find(id);
            if (dash == null)
            {
                return NotFound();
            }
        ...
        public JsonResult Edit(leaddashbordorder dash)
        {
            bool stat = false;
            string msg;
            ...
            if (ModelState.IsValid)
            {
                    ...
                    var UserId = User.Identity.GetUserId();
                    com.addlog(LogTypes.Updated, UserId, "leaddashboard", "leaddashboard", findip(), dash.leaddashboardid, "leaddashboard Updated Successfully");


                    msg = "Successfully updated Lead Dashboard details.";
                    stat = true;
        ...
        public ActionResult Delete(long? id)
        {
            ...
            leaddashbordorder leaddash = db.leaddashbordorder.Find(id);
            if (leaddash == null)
            {
                return NotFound();
            }
        ...
        public bool DeleteFn(long id)
        {
            ...
            if (leaddash != null)
            {
                db.leaddashbordorder.RemoveRange(db.leaddashbordorder.Where(a => a.leaddashboardid == id));
            }

            var UserId = User.Identity.GetUserId();
            com.addlog(LogTypes.Deleted, UserId, "leaddashboard", "leaddashboard", findip(), leaddash.leaddashboardid, "leaddashboard Deleted Successfully");
            db.SaveChanges();
            return true;
        }
