...
function addrow(t, action, Unit, Quantity, Price, Amount, Item, ItemName, ItemWithCode, ItemNote, itemdata, ConFactor) {
    if (count == limits) alert("You have reached the limit of adding " + count + " inputs");
        ...
        data = "<td class='text-center' id=" + divid + "> " + slno + " </td>" +
            "<td class='input-group input-group-sm'><select class='form-control item_name' " + required + " data-id='" + count + "' placeholder='Item Name' data-msg-required='The Item Name is required' id='item_name_" + count + "'  data-val-required='The Item field is required' onchange='GetItemdetails(this," + count + ",\"" + type + "\")'>" + Option + "</select> " + itemaddbtn + "</td>" +
            "<td >Unit<select class='form-control units unit_name_" + count + "' id='unit_name_" + count + "' " + required + " data-id='" + count + "' id='unit_name' onchange='unitchange(this," + count + ",\"" + type + "\");'>''</select></td>" +
            "<td style='width:21%!important;'>Qty<input type='number' name='product_quantity[]' onchange='quantity_change(" + count + ");' id='total_qntt_" + count + "' value='" + Quantity + "'  class='total_qntt_" + count + " form-control text-right quty' placeholder='Enter Quantity' min='0' tabindex='" + tab2 + "'/></td>" +
            "<td style='width:21%!important;'>Price<input type='number' data-msg-required='The Item Rate is required' name='product_rate[]' " + required + " onchange='rate_change(" + count + ",\"" + type + "\");' id='price_item_" + count + "' value='" + Price + "' class='price_item_" + count + " form-control text-right totrate' placeholder='0.00' min='0' tabindex='" + tab3 + "'/><input type='hidden' data-value='" + price + "' value='" + baseprice + "' name='base_rate' id='base_rate_" + count + "'></td>" +
            "<td style='width:21%!important;'>Amount<input type='number' name='sub_total[]' id='sub_total_" + count + "' class='sub_total_" + count + " form-control text-right subtotal' value='" + Amount + "'   placeholder='0.00' min='0' tabindex='" + tab3 + "' readonly='readonly'/><input type='hidden' value='" + ConFactor + "' class='cfactor' name='cfactor' id='cfactor_" + count + "'/>" +
            "<td class='text-center'><button tabindex='" + tab5 + "' style='text-align: right;' class='btn btn-danger'  id='sh-btn-dlt2' type='button' value='Delete' onclick='deleteRow(this)'><i class='fa fa-trash fa-1x'></i></button>" + itemnote + htdata + "</td>";
        row += data + "</tr>";
        $('#' + t).append(row);
...
function addbillsundry(t, action, BsValue, AmountType, BsAmount, BsType, BSName, billsundry) {
    if (bcount == blimits) alert("You have reached the limit of adding " + bcount + " inputs");
        ...
        data = "<td class='text-center'>" + slno + "</td>" +
            ...
            "<td style='width:80px!important;'><input type='number' data-name='BsValue' " + readonly + " value='" + BsValue + "'  class='form-control bsvalue_" + bcount + "' onchange='bsvaluechange(" + bcount + ");' id='bsvalue_" + bcount + "' data-id='" + bcount + "' id='bsvalue' /></td>" +
            "<td style='width:80px!important;'><input type='text' data-name='' value='" + Type + "' class='form-control bsamttype_" + bcount + "' id='bsamttype_" + bcount + "' data-id='" + bcount + "' id='bsamttype' readonly='readonly'/></td>" +
            "<td style='width:83px!important;'><input type='number' data-name='BsAmount' value='" + BsAmount + "' class='form-control bsamt bsamt_" + bcount + "' onchange='bsamtchange(" + bcount + ");' id='bsamt_" + bcount + "' data-id='" + bcount + "' id='bsamt' value='0.00' placeholder='0.00'/><input type='hidden' data-name='AmountType'  value='" + AmountType + "' class='amttypevalue' name='amttypevalue' id='amttypevalue_" + bcount + "'/><input type='hidden' value='" + BsType + "' data-name='BsType'  class='bstype' name='bstype' id='bstype_" + bcount + "'/></td>" +
            "<td class='text-center'><button style='text-align: right;'  class='btn btn-danger sh-btn-style3' type='button' value='Delete' onclick='deletebsRow(this)'><i class='fa fa-trash fa-1x'></i></button></td>",
            row += data + "</tr>";
        $('#' + t).append(row);
        searchbs();
        bcount++;
