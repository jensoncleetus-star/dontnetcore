...
//Add Row 
var pcount = 2;
function addrow(t, action, ItemUnit, ItemQuantity,Remarks,Item, ItemCode, ItemName, ItemWithCode, ItemNote, itemdata, ItemMake, ItemMakeName) {
    ...
    if (count == limits) alert("You have reached the limit of adding " + count + " inputs");
        ...
        if (itemdata != null && ItemMake != null && ItemMakeName != null) {
            OptionBr = "<option value='" + ItemMake + "'>" + ItemMakeName + "</option>"
        }
        ...
        var chkbr="";
        if (makecheck == "active") {
            data += "<td class='input-group input-group-sm'><select class='form-control brand_name' name='brand_name' data-id='" + count + "' placeholder='brand' id='brand_name_" + count + "'>" + OptionBr + "</select>" + brandaddbtn + "</td>"
        } else {
            chkbr="<input type='hidden' class='hidebrand_name' value='0' name='brand_name' id='brand_name_" + count + "'/>";
        }

        data += "<td>" + chkbr + "<input type='text' name='product_remarks[]' id='total_remarks_" + count + "' value='" + Remarks + "'  class='total_remarks_" + count + " form-control text-right remarks' tabindex='" + tab3 + "'/> " +
        ...
        if (prochk == "active") {
            data += "<td><select class='form-control project_name' name='project_name' data-id='" + count + "' placeholder='Project' id='project_name_" + count + "'  onchange='GetProjectChange(this," + count + ",\"" + type + "\")'>" + OptionPro + "</select></td>";
            data += "<td><select class='form-control task_name' data-id='" + count + "' name='task_name' placeholder='Task' id='task_name_" + count + "'>" + OptionTsk + "</select></td>";
        }
...
function PrintInvoice(e, type) {
    ...
    if (e.summary.CPorderNo != null && e.summary.CPorderNo !== "" && e.summary.CPorderNo != 0) {
        ...
        $("#lblPONo").text(": " + e.summary.CPorderNo);
        $("#divtconvert").show();
    }
    else {
        $("#divtconvert").hide();
    ...
    $("#lblApproved").text(e.summary.CreatedBy);
    if (e.summary.RequestedDate != null) {
        $("#IblReqDate").text(convertToDate(e.summary.RequestedDate));
    }
...
function bindItem(e) {
    ...
    $.each(e.item, function (i, item) {
        ...
        str += '<td class="text-center">' + item.Remarks + '</td>';
        ...
        if (prochk == "active") {
            ...
            var project = pro + "<br/><small>" + tsk + "</small>";
            str += '<td class="text-center">' + project + '</td>';
        } else {
            $('.prj').hide();
        }
        str += '</tr>';
