...
//Add Row 
var pcount = 2;
function addrow(t, action, ItemUnit, ItemTax, ItemTotalAmount, ItemQuantity, Item, ItemCode, ItemName, ItemUnitPrice, ItemSubTotal, ItemWithCode, ItemTaxAmount, ItemDiscount, ItemNote, itemdata, ItemCategory, ItemBrand, PPRICE, MRP, SellPrice, BPrice, tag1, tag2, tag3, tag4, tag5, prefix, division, supplier, ItemMake, ItemMakeName) {
    ...
    if (count == limits) alert("You have reached the limit of adding " + count + " inputs");
        ...
        if (makecheck == "active") {
            protask += "<td  class='input-group input-group-sm'><select class='form-control brand_name' name='brand_name' data-id='" + count + "' placeholder='brand' id='brand_name_" + count + "'>" + OptionMake + "</select>" + brandaddbtn + "</td>";
        }
