...
namespace QuickSoft.ViewModel
{
    public class JournalViewModel
    {
        ...
        [Display(Name = "Pay From 1(Credit)")]
        public long? PayFrom1 { get; set; }
        [Display(Name = "Pay From 2(Credit)")]
        ...
        public IEnumerable<IFormFile> RecieptDoc { get; set; }
        public ICollection<JournalVItems2> jnlitems { get; set; }


    }
    public class JournalVItems2
    {
